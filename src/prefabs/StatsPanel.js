...
export default class StatsPanel extends Phaser.GameObjects.Container {
  ...
  updateStats(player) {
    ...
    setValueColor(this.hpValue, stats.currentHealth, 1000);
    setValueColor(this.attackValue, stats.atk, 100);
    setValueColor(this.speedValue, stats.speed, 600);
    setValueColor(this.turnRateValue, stats.turnSpeed, 0.1);
    setValueColor(this.regenValue, stats.regen, 50);
