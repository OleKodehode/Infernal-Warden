...
export default class Player extends Phaser.GameObjects.Container {
	...
	constructor(scene, x, y) {
    	...
    	this.stats = { speed: 220, turnSpeed: 0.05, maxHealth: 100, currentHealth: 100, atk: 10, fireRate: 2.0, projectiles: 1, regen: 0.5, armor: 0};
		this.isAlive = true;
  ...
  updateHealthBar() {
	...
	const percent = Phaser.Math.Clamp(this.stats.currentHealth / this.stats.maxHealth, 0, 1);
